...
This is a variable version of robomatn intended to be a 1:1 match with the official non-variable release from Google.

This is not an official Google project, but was enabled with generous funding by Google Fonts, who contracted Type Network.
The robomatn family of instances contained 6 weights and two widths of normal, along with italic of the regular width.
The project began by taking UFO instances generated during the build process of the robomatn v2.136 release, which have quadratic outlines. 
...
* [github.com/TypeNetwork/robomatn/releases](https://github.com/TypeNetwork/robomatn/releases) contains variation font TTFs.
...
- Make a VTT source font which contains the existing hinting data by running `sh sources/make_vtt_src_font.sh`. The font will be exported to `sources/robomatn[ital,wdth,wght]_VTT.ttf`.
...
robomatn provides the following sibling families:
...
It is advisable to use the robomatn webfonts that are available at https://fonts.google.com/specimen/robomatn instead.
